...
public class initMain_level : MonoBehaviour {
	...
	void Start () {
		...
		a.GetComponent<Player>().playermaxlife = 10000;// PlayerPrefs.GetInt ("playershengming" + Plane_Gameclass.playerleading.ToString ());
		...
		a.GetComponent<Player>().bulletspeed = 0.2f; //(float)(10.0f/PlayerPrefs.GetInt ("playerfangyu" + Plane_Gameclass.playerleading.ToString ()));
	}	
